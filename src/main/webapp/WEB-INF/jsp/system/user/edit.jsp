				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入用户名"
							value="${user.userName}" name="userFormMap.userName"
							id="userName">
					</div>
				</div>
					...
					<div class="col-sm-9">
						<div class="btn-group m-r">
							<select id="locked" name="userFormMap.locked"
								...
								<option value="0"
									<c:if test="${user.locked eq 0}">selected="selected"</c:if>>是</option>
								<option value="1"
									<c:if test="${user.locked eq 1}">selected="selected"</c:if>>否</option>
							</select>
