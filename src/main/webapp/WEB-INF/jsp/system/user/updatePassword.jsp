...
<script type="text/javascript"
	src="${ctx}/js/system/user/updatePassword.js"></script>
<style type="text/css">
.col-sm-3 {
	width: 25%;
	float: left;
...
<body>
	...
	<form id="formUpdatePwd" name="form" class="form-horizontal"
		...
		<input type="hidden" class="form-control checkacc"
			...
			value="${userSession.accountName}" name="userFormMap.accountName"
			id="accountName"> <input type="hidden"
			class="form-control checkacc" value="${userSession.password}"
