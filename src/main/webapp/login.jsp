...
<body onload="javascript:to_top()"
	style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/11.jpg');margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;">
	<div id="loginbox" style="padding-top: 10%;">
		<form id="loginform" name="loginform" class="form-vertical"
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
						<td align="center" style="font-weight: bold; color: white;">牛耳教育信息管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
			...
			<div class="form-actions">
				<span class="pull-left" style="width: 33%"> </span> <span
					class="pull-right"> <a type="submit"
					href="javascript:checkUserForm()" class="btn btn-success">登&nbsp;&nbsp;录</a>
				</span>
			</div>
		</form>
	</div>
