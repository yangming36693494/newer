...
import com.yangming.entity.LogFormMap;
import com.yangming.mapper.LogMapper;
...
public class LogAopAction {
	...
	// Controller层切点
	@Pointcut("@annotation(com.yangming.annotation.SystemLog)")
